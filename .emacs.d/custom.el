(custom-set-variables
 ...
 '(package-selected-packages
   '(dashboard xterm-title jammer html-mode dhall-mode exec-path-from-shell highlight-indent-guides centered-cursor-mode prettier-js evil-magit magit-todos magit typescript-mode auto-compile gcmh git-timemachine highlight-numbers hl-todo lsp-ui lsp-mode flycheck smex counsel-projectile projectile counsel company general evil-easymotion avy origami web-mode rust-mode graphql-mode yaml-mode json-mode gitignore-mode gitconfig-mode which-key evil-mc evil-surround evil-collection evil-terminal-cursor-changer evil use-package no-littering))
