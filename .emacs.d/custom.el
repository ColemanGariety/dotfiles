...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(ivy-current-match ((t (:extend t :background "#3A3A3A"))))
 '(mode-line-inactive ((t (:background "#37302f" :foreground "#665c54" :box nil))))
 '(tree-sitter-hl-face:function\.call ((t (:inherit (link font-lock-function-name-face) :foreground "darkseagreen" :underline nil))))
 '(tree-sitter-hl-face:property ((t (:inherit font-lock-constant-face)))))
 ;; '(mode-line-inactive ((t (:background "#37302f" :foreground "#665c54" :box nil))))
 ;; '(vertical-border ((t (:background "#37302f" :foreground "#37302f")))))
