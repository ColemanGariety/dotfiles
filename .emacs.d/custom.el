(custom-set-variables
 ...
 '(package-selected-packages
   '(evil-numbers evil-mc evil-matchit graphql-mode smex counsel-projectile lsp-ui lsp-mode corfu-quit-at-boundary straight\.el straight corfu-terminal evilem evil-leader marginalia doom-themes company-lsp coverlay yaml-mode doom-modeline which-key use-package undo-tree typescript-mode tree-sitter-langs prettier-js origami no-littering json-mode hl-todo highlight-numbers git-timemachine general flycheck evil-terminal-cursor-changer evil-surround evil-easymotion evil-collection evil-anzu dashboard company))
